          ...
          <div className={styles.content}>
            <div className={styles.intro}>
              ...
              <p>
                ...
                <strong>Pumpkin Spice Latte,</strong> la mezcla perfecta de
                café, especias y cremosidad. Atrévete con nuestro{" "}
                <strong>Pumpkin Spice Farappucino</strong> si no quieres
                renunciar a tu bebida fría, ¡te encantará! y si eres amante del
                café intenso nuestro <strong>Pumpkin Spice Cold Brew</strong>{" "}
                está hecho para ti.<br></br>
